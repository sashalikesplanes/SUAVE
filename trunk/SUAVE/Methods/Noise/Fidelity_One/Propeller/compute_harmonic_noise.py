...
from SUAVE.Methods.Noise.Fidelity_One.Noise_Tools            import SPL_harmonic_to_third_octave_old
...
def compute_harmonic_noise(harmonics,freestream,angle_of_attack,position_vector,velocity_vector,
    ...
    harmonic_noise_results.f          = B*omega*m/(2*np.pi) 
    ...
    harmonic_noise_results.SPL_prop_harmonic_bpf_spectrum     = 20*np.log10((abs(p_mL_H_abs + p_mT_H_abs))/p_ref) 
    harmonic_noise_results.SPL_prop_harmonic_bpf_spectrum_dBA = A_weighting(harmonic_noise_results.SPL_prop_harmonic_bpf_spectrum,harmonic_noise_results.f[:,:,:,0,:]) 
    harmonic_noise_results.SPL_prop_harmonic_1_3_spectrum     = SPL_harmonic_to_third_octave_old(harmonic_noise_results.SPL_prop_harmonic_bpf_spectrum,harmonic_noise_results.f[:,0,0,0,:],settings)         
    harmonic_noise_results.SPL_prop_harmonic_1_3_spectrum_dBA = SPL_harmonic_to_third_octave_old(harmonic_noise_results.SPL_prop_harmonic_bpf_spectrum_dBA,harmonic_noise_results.f[:,0,0,0,:],settings)  
    harmonic_noise_results.SPL_prop_harmonic_1_3_spectrum[np.isinf(harmonic_noise_results.SPL_prop_harmonic_1_3_spectrum)]         = 0
    harmonic_noise_results.SPL_prop_harmonic_1_3_spectrum_dBA[np.isinf(harmonic_noise_results.SPL_prop_harmonic_1_3_spectrum_dBA)] = 0


    harmonic_noise_results.p_pref_harmonic                    = 10**(harmonic_noise_results.SPL_prop_harmonic_bpf_spectrum/10)   
    harmonic_noise_results._pref_harmonic_dBA                = 10**(harmonic_noise_results.SPL_prop_harmonic_bpf_spectrum_dBA/10)  
    ...
    az_time    = np.tile(aeroacoustic_data.omega[:,:,None,None,None],(1,num_mic,num_rot,num_azi,num_h))
    p_t        = np.sum((p_mT_H_azi + p_mL_H_azi)*np.exp(-1j*m_azi*B*omega_azi*az_time),axis = 4)
    p_t_abs    = abs(p_t)

    harmonic_noise_results.p_harmonic     = p_t_abs 
    harmonic_noise_results.azimuthal_time = az_time 
